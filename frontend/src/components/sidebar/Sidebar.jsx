...
export default function Sidebar({ onSelectConv, onOpenDocs, docsCount }) {
    ...
    useEffect(() => {
        ...
        // eslint-disable-next-line react-hooks/exhaustive-deps -- toggle is store action; stable reference
    }, [open]);
    ...
    const submitRename = async () => {
        ...
        setRenamingId(null);
        try { await convApi.rename(renamingId, renameText.trim()); } catch { /* optimistic update — server failure surfaces on next refresh */ }
    };
            ...
            <aside className={`sidebar ${open ? '' : 'collapsed'}`}>
                ...
                <div className="sidebar-footer">
                    <div className="sidebar-footer-links">
                        ...
                        <button className="sidebar-footer-link" onClick={() => navigate('/help')}>
